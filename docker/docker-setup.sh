...
echo ""
echo "docker run -it --rm --env-file ~/.config/brief/.env -v ~/.config/brief:/home/brief/.config/brief brief"
echo ""
echo "Alternativ kannst du API-Keys auch direkt als Umgebungsvariablen übergeben:"
echo "docker run -it --rm -e OPENAI_API_KEY=\$OPENAI_API_KEY -v ~/.config/brief:/home/brief/.config/brief brief"
